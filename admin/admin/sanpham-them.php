...
<body>
    ...
    <div class="container-fluid">
        <?php
        require '../connect.php';
        $query = "SELECT * FROM hang-hoa";
        $hang_hoa = $conn->query($query);
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" name="id_lsp">
                                        <?php
                                        if ($loai->num_rows > 0) :
                                            while ($loai = $hang_hoa->fetch_assoc()) :
                                        ?>
                                                <option value="<?= $loai['ma_loai'] ?>"><?= $loai['ten_hh'] ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" name="trangthai">
                                        ...
                                        <option value="0">Đã bán hết</option>
