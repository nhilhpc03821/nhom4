    ...
    ?>
            <div class="col-sm-4">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="../uploads/<?= $sanpham['hinhanh'] ?>" alt="Card image cap" width="250px">
                    <div class="card-body">
                        <h5 class="card-title"><?= $sanpham['ten'] ?></h5>
                        <p class="card-text"><?= $sanpham['mota'] ?></p>
                        <p class="card-title"><?= number_format($sanpham['gia']) ?> đ</p>
                        <form action="giohang-xuly.php" method="post">
                            <input type="hidden" name="id_sp" id="" value="<?= $sanpham['id_sp'] ?>">
                            <button class="btn btn-dark" type="submit" name="them">Thêm vào giỏ hàng</button>
                        </form>
                    </div>
                </div>
            </div>
