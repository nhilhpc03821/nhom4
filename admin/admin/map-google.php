...
<header class="topbar" data-navbarbg="skin5">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item pt-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="dashboard.php"
                                ...
                                <span class="hide-menu">Bản điều khiển</span>
                            </a>
                        </li>
    ...
    <script src="../asset/admin/plugins/bower_components/gmaps/gmaps.min.js"></script>
    <script src="../asset/admin/plugins/bower_components/gmaps/jquery.gmaps.js"></script>
