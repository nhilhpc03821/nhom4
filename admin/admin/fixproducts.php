            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="danhsachsanpham.php"
                                aria-expanded="false">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><a href="../admin/dashboard.php" class="fw-normal">Bảng điều khiển</a></li>
                            </ol>
                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="../asset/admin/plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        ...
                                        <h4 class="text-white mt-2">Nguyễn Tấn Lộc</h4>
                                        <h5 class="text-white mt-2">locntpc03766</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                    ...
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Giá sản phẩm</label>
                                        <div class="col-md-12 border-bottom p-0">
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Mã sản phẩm</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="" class="form-control p-0 border-0" placeholder = "Nhập mã sản phẩm">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="col-sm-12">Nguồn</label>
