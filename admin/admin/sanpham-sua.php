                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" name="id_lsp">
                                            ...
                                            ?>
                                                    <option value="<?= $loai['ma_loai'] ?>" <?= ($loaisanpham['ma_loai'] == $sanpham['ma_loai'] ? 'selected' : '') ?>><?= $loaisanpham['ten'] ?></option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" name="trangthai">
                                            <option value="1" <?= ($sanpham['trangthai'] == 1 ? 'selected' : '') ?>> Còn Sản Phẩm </option>
                                            <option value="0" <?= ($sanpham['trangthai'] == 0 ? 'selected' : '') ?>> Đã Bán Hết </option>
