...
<body>
  ...
  <div class="banner text-center" style="margin-top: 78px;">
    <img id="img" class="baner_anh" onclick="changeImage()" src="../asset/dlient/img/banner_1.jpg  " width="100%" height="900px">
  ...
  endforeach; ?>
    ...
    <hr class="sep-2" />
    <h2 class="tieu-de text-center">loại hình sắp ra mắt</h2>
    ...
    <div class="container">
      ...
      <img class="sticky" src="../asset/dlient/img/phong_tong_thong_4.jpg" alt="Avatar" width=400px">
    ...
    <hr class="sep-2" />
    <h2 class="tieu-de text-center">sơ lược về Khách sạn</h2>
