                ...
                <div class="card-body">
                    ...
                    <table class="w-100">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><strong>Số Lượng Phòng:</strong></th>
                                <td><?= $_POST['so_luong_phong'] ?></td>
                            </tr>
                            <tr>
                                <th scope="row"><strong>Giá:</strong></th>
                                <td><?= number_format($_POST['gia'], 3, ',', '.') ?> * <?= $_POST['so_luong_phong'] ?> phòng =
                                    <b> <?= number_format($_POST['gia'] * $_POST['so_luong_phong'], 3, ',', '.')  ?> VND</strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
