...
<head>
   ...
   <script src="../asset/dlient/JS/dangnhap.js"></script>
         ...
         <form method="POST" action="login-ac.php" class="needs-validation" novalidate="" autocomplete="off">
            ...
            <div class="d-flex align-items-center">
               <div class="form-check">
                  ...
                  <label for="remember" class="form-check-label">Lưu Mật Khẩu</label>
               </div>
            ...
            <div class="mb-3 text-center">
               <i>Hoặc</i>
               <div class="item-login" style="margin-top: 10px;">
            ...
            <div class="chuyen-huong">
               <u> <i>Bạn Chưa Có Tài Khoản</i><a href="./DangKy.php"> Đăng Kí</a> ngay</i></u>
            </div>
