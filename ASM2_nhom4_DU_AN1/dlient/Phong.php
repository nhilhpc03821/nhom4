...
<body>
  ...
  <center>
    ...
    <H1 class="chu_01"> Phòng Đơn VIP 1 CỦA KHÁCH SẠN</H1>
    <br />
    <div class="menu">
      <div class="gallery">
        ...
        <div class="desc"><b>Trà Đào Latter</b></div>
      </div>
      ...
      <div class="gallery">
        ...
        <div class="desc"><b>Sinh Tố Trái Cây Latter</b></div>
      </div>
      ...
      <div class="gallery">
        ...
        <div class="desc"><b>Trà Dâu Dưa Hấu</b></div>
      </div>
  ...
  <center>
    ...
    <H1 class="chu_01"> Phòng đôi VIP tại khách sạn</H1>
    <br />
    <div class="menu">
      <div class="gallery">
        ...
        <div class="desc"><b>Macaron</b></div>
      </div>
      ...
      <div class="gallery">
        ...
        <div class="desc"><b>Baba au Rhum</b></div>
      </div>
      ...
      <div class="gallery">
        ...
        <div class="desc"><b>Noël légère chocolat</b></div>
      </div>
  ...
  <center>
    ...
    <H1 class="chu_01"> Phòng đôi hai giường và phòng đơn loại thường tại khách sạn</H1>
    <br />
    <div class="menu">
      <div class="gallery">
        <a href="../dlient/sanpham_7.html">
          <img src="../asset/dlient/img/giuong doi_thường.1.jpg" alt="Cinque Terre" width="600" height="200">
        </a>
        <div class="desc"><b>Macaron</b></div>
      </div>
      ...
      <div class="gallery">
        <a href="../dlient/sanpham_8.html">
          <img src="../asset/dlient/img/giuong doi_thường.2.jpg" alt="Forest" width="600" height="400">
        </a>
        <div class="desc"><b>Baba au Rhum</b></div>
      </div>
      ...
      <div class="gallery">
        <a href="../dlient/sanpham_9.html">
          <img src="../asset/dlient/img/giuong doi_thường.3.jpg" alt="Northern Lights" width="600" height="400">
        </a>
        <div class="desc"><b>Noël légère chocolat</b></div>
      </div>
      ...
      <div class="gallery">
        <a href="../dlient/sanpham_10.html">
          <img src="../asset/dlient/img/giuong doi_thường.4.jpg" alt="Mountains" width="600" height="400">
        </a>
        <div class="desc"><b> Charlotte</b></div>
      </div>
      <div class="gallery">
        <a href="../dlient/sanpham_11.html">
          <img src="../asset/dlient/img/giuong doi_thường.5.jpg" alt="Mountains" width="600" height="400">
        </a>
        <div class="desc"><b> Dacquoises </b></div>
      </div>
      <div class="gallery">
        <a href="../dlient/sanpham_12.html">
          <img src="../asset/dlient/img/giuong doi_thường.6.jpg" alt="Mountains" width="600" height="400">
        </a>
        <div class="desc"><b>Quatre Quarts</b></div>
  ...
  <div class="fooder">
    <div class="fooder_into">
      ...
      <p> <img src="../asset/dlient/img/Icon/map.png" width="20px"> <b>288 Đ. Nguyễn Văn Linh, Hưng Lợi, Ninh Kiều, Cần Thơ, Việt Nam </b> </p>
      <p> <img src="../asset/dlient/img/Icon/call.png" width="20px"><b>+094 729 1927</b></p>
    ...
    <div class="fooder_into_01">
      ...
      <p class="banh"><img src="../asset/dlient/img/Icon/right-arrow.png" width="10px"> <b> Giao bánh tại nhà </b></p>
      <p class="banh"><img src="../asset/dlient/img/Icon/right-arrow.png" width="10px"> <b> Vocher tháng 10 khi mua nước </b></p>
  ...
  <h4 class="chu_fooder">Được thiết kế bởi Lê Hồng Nhi <br />
    Được phân phối bởi: ThemeWagon</h4>
  </div>
